...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=serlcr-net.dat>
  <DataDisplay=serlcr-net.dpl>
  <OpenDisplay=1>
  <Script=serlcr-net.m>
  <RunScript=0>
  <showFrame=0>
...
<Components>
  ...
  <Eqn Eqn1 5 440 340 -47 20 0 0 "L1v=L*1e-6" 1 "C1v=C*1e-12" 1 "yes" 0>
  <C C1 1 550 260 -20 27 0 0 "C1v" 1 "" 0 "neutral" 0>
  <Port P2 1 610 260 40 -26 1 2 "2" 1 "analog" 0>
</Components>
<Wires>
  <420 260 440 260 "" 0 0 0 "">
  <310 260 360 260 "" 0 0 0 "">
